...
<style type="text/css">
  @font-face {
    ...
    font-style: normal;
    font-weight: normal;
    src: local('Nodesto Caps Condensed'), url("https://raw.githubusercontent.com/Nioux/AideDeJeu/master/Hereva/fonts/Nodesto Caps Condensedtest.otf") format('opentype');
