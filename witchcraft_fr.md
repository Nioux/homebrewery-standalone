...
<style type="text/css">
  @font-face {
    ...
    font-style: normal;
    font-weight: normal;
    src: local('Nodesto Caps Condensed'), url("https://raw.githubusercontent.com/Nioux/AideDeJeu/master/Hereva/fonts/Nodesto%20Caps%20Condensed.otf") format('opentype');
...
<img src="https://github.com/Nioux/homebrewery-standalone/raw/master/images/title_background.png" style='position:absolute;top:0px;left:0px;width:816px'/>
